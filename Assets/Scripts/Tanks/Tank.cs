...
public abstract class Tank : MonoBehaviour {
    ...
    GamePad.Index idx;
    XInputDotNetPure.PlayerIndex xIdx = XInputDotNetPure.PlayerIndex.One;
    XInputDotNetPure.GamePadState state;
    ...
    void Start()
    {
        ...
        state = XInputDotNetPure.GamePad.GetState(xIdx);
    }
